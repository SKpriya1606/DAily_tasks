package com.cts.training.currencyconversionservice.bean;
...
public class CurrencyConversionBean {
	...
	public CurrencyConversionBean(Long id, String from, String to, BigDecimal converionMultiple, BigDecimal quantity,
